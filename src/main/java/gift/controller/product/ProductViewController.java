...
public class ProductViewController {
    ...
    public String showProducts(Model model) {
        ...
        if (!model.containsAttribute("requestDto")) {
            model.addAttribute("requestDto", new ProductRequestDto(null, 0, 1, ""));
        }

        if (!model.containsAttribute("updateDto")) {
            model.addAttribute("updateDto", new ProductRequestDto(null, 0, 1, ""));
        }
    ...
    public String updateProduct(
        ...
        if (bindingResult.hasErrors()) {
            ...
            if (!redirectAttributes.containsAttribute("requestDto")) {
                redirectAttributes.addFlashAttribute("requestDto",
                    new ProductRequestDto(null, 0, 1, ""));
            }
        ...
        productService.update(id,
            new ProductRequestDto(requestDto.name(), requestDto.price(), requestDto.quantity(), requestDto.imageUrl()));
